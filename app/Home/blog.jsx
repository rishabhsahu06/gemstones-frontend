    ...
    return (
        <section className="container mx-auto">
            <div className="text-center mb-12 mt-12">
                <h1 className="text-2xl md:text-3xl font-bold text-center mb-2 mt-16 ">Latest Blogs</h1>
                <p className="text-[16px] md-text-[20px] font-helvatica text-center text-[#4F4F4F] mb-10">Your Guide to All Things Style, Wellness & Gemstones</p>
            </div>
